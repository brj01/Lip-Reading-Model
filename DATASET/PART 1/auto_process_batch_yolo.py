...
for file_item in file_list[start:end]:
    ...
    single_yolo_path = os.path.join(script_dir, "auto_single_yolo.py")
    cmd = "CUDA_VISIBLE_DEVICES={} nohup python3 {} --file_path {} {} --batch_num {} >> auto_process_yolo2/{}_{}_autoprocess_log_{:03d}.log 2>&1 &".format(gpui, single_yolo_path, file_path, batch_num, batch_num, start, cpui)
    print(cmd)
    os.system(cmd)
    cpui += 1
